...
import { FileText, Landmark, Award, ChevronLeft, ArrowRight } from 'lucide-react';
...
const Municipal = () => {
  ...
  const services = [
    { id: 'property-tax', name: t('propertyTax'), sub: t('propertyTaxSub'), icon: <Landmark size={28} />, path: '/service/municipal/tax' },
    { id: 'certificates', name: t('certificates'), sub: t('certificatesSub'), icon: <Award size={28} />, path: '/service/municipal/certificate' },
    { id: 'grievance', name: t('municipalGrievance'), sub: t('municipalGrievanceSub'), icon: <FileText size={28} />, path: '/service/municipal/grievance' },
  ];
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-800 uppercase tracking-tight">{t('municipalServices')}</h1>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">{t('municipalDept')}</p>
        </div>
      </div>
